// Circular Habit Tracker Controller - Version 2 Reversion
...
function initializeDefaultHabits() {
    if (state.habits.length === 0) {
        state.habits = [
            { id: "h1", name: "", colorIndex: 1, active: true },
            { id: "h2", name: "", colorIndex: 2, active: true },
            { id: "h3", name: "", colorIndex: 3, active: true },
            { id: "h4", name: "", colorIndex: 4, active: true },
            { id: "h5", name: "", colorIndex: 5, active: true },
            { id: "h6", name: "", colorIndex: 6, active: true },
            { id: "h7", name: "", colorIndex: 7, active: true },
            { id: "h8", name: "", colorIndex: 8, active: true }
        ];
        saveToLocalStorage();
    }
}
